...
*)
    ...
    *)
    ...
    let ``34 Partially specifying arguments (Part 3).`` () =
        ...
        let cows x = f "cow" x // <-- multiple words on this line, or you may want to make this a multi-line thing.  You MUST use `f`.
